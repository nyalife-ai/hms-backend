import { DTO_TEMPLATE, SPEC_TEMPLATE } from '../templates/templates';
...
export class DtoGenerator {
  ...
  public generate(options: GeneratorOptions): GeneratedFile[] {
    ...
    return [
      {
        path: `${directory}/${options.name}.dto.ts`,
        contents: this.templates.render(DTO_TEMPLATE, variables),
      },
      {
        path: `${directory}/${options.name}.dto.spec.ts`,
