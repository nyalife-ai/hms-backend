/**
 * Optional driver loading, scoped to the documents platform slice.
 *
 ...
 * spreadsheet/template drivers (`exceljs`, `handlebars`, `marked`, `qrcode`)
 * are therefore optional: callers get a working scaffold without installing
 * every driver, and an actionable error when a genuinely required one is
 * missing.
 */
