/**
 * File: appointments.repository.ts
...
import { PrismaAppointmentRepository } from './prisma/prisma-appointment.repository';
...
export const AppointmentRepositoryProvider: Provider = {
