...
import { PrismaWardRepository } from './prisma/prisma-ward.repository';
...
export const WardRepositoryProvider: Provider = {
  provide: WARDS_REPOSITORY,
  inject: [ConfigService, PrismaService],
  useFactory: (config: ConfigService, prisma: PrismaService) => {
    if (resolveOrmType(config) === 'prisma') {
      return new PrismaWardRepository(prisma);
    }
